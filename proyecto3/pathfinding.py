...
def astar(start, end, paredes, tactical_points=None):
    ...
    while not open_set.empty():
        ...
        for vecino in vecinos:
            ...
            # Reducir costo si el vecino es un punto táctico
            if tactical_points and vecino in tactical_points:
                tentative_g_score -= 0.5  # Prioridad alta para puntos tácticos
